        ...
        <div className="sticky top-0 z-10 flex flex-col bg-background-light dark:bg-background-dark pt-4 max-w-7xl mx-auto px-4 w-full">
          <div className="flex items-center gap-4 pb-2">
            ...
            <div className="relative group">
              ...
              <div className="absolute right-0 top-full w-48 pt-2 hidden group-hover:block z-20">
                <div className="bg-white dark:bg-[#1a1a1a] border border-gray-200 dark:border-white/10 rounded-xl shadow-xl py-2">
              ...
              {products.map((product) => (
                <Link key={product.id} to={`/products/${product.id}`} className="group block">
                  <div className="flex flex-col gap-3">
                    <div className="relative w-full overflow-hidden rounded-2xl bg-slate-200 dark:bg-white/5 aspect-square group-hover:shadow-lg transition-all duration-300">
                      {/* Product Image */}
                      {product.image_url ? (
                        <img
